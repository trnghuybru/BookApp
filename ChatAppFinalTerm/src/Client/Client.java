...
public class Client extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        String accountString = txtPhone.getText() + "," + txtPassword.getText();
                    ...
                    while (true) {
                        ...
                        if (messageSplit[0].equals("login")) {
                            if (messageSplit[1].equals("success")) {
                                ...
                                JOptionPane.showMessageDialog(null, "Đăng nhập thành công không thành công do sai mật khẩu hoặc tài khoản không tồn tại", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
